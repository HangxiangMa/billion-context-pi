...
export interface AcpRuntime {
  ...
  markNudgeShown(sid: string, turnKey: string): void;
...
export function createRuntime(adapter: AdapterConfig): AcpRuntime {
  ...
  function markNudgeShown(sid: string, turnKey: string): void {
